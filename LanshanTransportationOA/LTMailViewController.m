...
@interface LTMailViewController ()

@end

@implementation LTMailViewController
...
- (void)getMailList{
    ...
    NSString *URLString = [NSString stringWithFormat:@"%@/maillist.php?act=shou&uid=%ld",
                           API_DOMAIN,uid];
...
- (void)getFaMailList{
    ...
    NSString *URLString = [NSString stringWithFormat:@"%@/maillist.php?act=fa&uid=%ld",
                           API_DOMAIN,uid];
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    manager.requestSerializer = [AFHTTPRequestSerializer serializer];
    manager.responseSerializer = [AFHTTPResponseSerializer serializer];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LTMailTableViewCell *cell = (LTMailTableViewCell*)[tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        cell = [[LTMailTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
