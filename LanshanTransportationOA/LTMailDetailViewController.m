...
#import "LTMailDetailViewController.h"
#import "SVProgressHUD.h"
#import "AFNetworking.h"
#import "NSObject+SBJson.h"

@interface LTMailDetailViewController ()

@end

@implementation LTMailDetailViewController
...
- (void)getDetails{
    ...
    NSString *URLString = [NSString stringWithFormat:@"%@/maillist.php?act=show&uid=%ld&id=%@",
    ...
    [manager POST:URLString parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([resultDict objectForKey:@"mailinfo"] && ![[resultDict objectForKey:@"mailinfo"] isEqual:[NSNull null]]) {
